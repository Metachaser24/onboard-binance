...
import {
  generateBinanceVerifierCircuitInputs,
  IBinanceCircuitInputs,
} from "@onboard-binance/circuits/helpers/inputs";
        ...
        <Column>
          ...
          <Button
            ...
            onClick={async () => {
              ...
              let input: IBinanceCircuitInputs;
              try {
                setDisplayMessage("Generating proof...");
                setStatus("generating-input");

                input = await generateBinanceVerifierCircuitInputs(emailBuffer, ethereumAddress);
